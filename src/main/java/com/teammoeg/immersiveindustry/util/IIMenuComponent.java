...
public record IIMenuComponent<S extends IMultiblockState,C extends AbstractContainerMenu>(MultiblockContainer<S,C> cont) implements IMultiblockComponent<S> {
